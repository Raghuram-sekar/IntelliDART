# Working IntelliDART Setup Script
Write-Host "🚀 IntelliDART - Working Setup" -ForegroundColor Green
...
if (Get-Command pip -ErrorAction SilentlyContinue) {
    ...
    Write-Host "❌ pip is missing" -ForegroundColor Red
}
...
Write-Host "3. Run 'docker-compose up' to start all services" -ForegroundColor White
Write-Host ""
