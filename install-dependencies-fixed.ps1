...
function Install-Python {
    ...
    if (!(Test-Command python)) {
        if (Test-Command choco) {
            ...
            Write-Host "❌ Chocolatey not found. Please install Python manually from https://www.python.org/" -ForegroundColor Red
        }
    } else {
...
function Install-PostgreSQL {
    ...
    if (!(Test-Command psql)) {
        if (Test-Command choco) {
            ...
            Write-Host "❌ Chocolatey not found. Please install PostgreSQL manually from https://www.postgresql.org/" -ForegroundColor Red
        }
    } else {
...
function Install-Docker {
    ...
    if (!(Test-Command docker)) {
        if (Test-Command choco) {
            ...
            Write-Host "❌ Chocolatey not found. Please install Docker Desktop manually from https://www.docker.com/" -ForegroundColor Red
        }
    } else {
